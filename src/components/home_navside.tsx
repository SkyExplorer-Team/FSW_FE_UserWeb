...
const HomeNavSide : React.FC = ()=>{
    return <div className="hidden xl:block col-start-2 col-span-2 py-6  bg-white rounded-[16px] shadow border border-gray-200 flex-col justify-center items-center gap-4">

...
const Index: React.FC = () => {
    ...
    const paginatedSchedulesActive = notifications.slice((currentPageActive - 1) * pageSize, currentPageActive * pageSize);
    const groupedNotifications = groupNotificationsByTime(paginatedSchedulesActive);
                    ...
                    <div className="my-5">
                        <div className="grid grid-cols-10 gap-5">
                            ...
                            <div className="col-start-1 col-span-10 xl:col-start-4 xl:col-span-6 px-8 py-3 bg-white rounded-[16px] shadow border border-gray-200 flex-col justify-center items-start inline-flex">
                                <div className="text-start text-[#111] font-medium font-['Plus Jakarta Sans'] font-semibold text-3xl mb-6">Notifications</div>
                                <div className="w-full min-h-[562px]">
                                    <div className="w-full grid grid-cols-10 gap-1">
                                        <div className="w-full col-start-1 col-span-10 flex-col justify-center items-start inline-flex">
                                            {groupedNotifications.map((groupedNotification, index) => (
                                                <div className="w-full" key={index}>
                                                     <div className="w-full grid grid-cols-10 gap-2">
                                                        <div className="col-start-1 col-end-2 flex-col text-center justify-top items-center inline-flex text-[#808991] font-medium text-sm mt-4">{groupedNotification.group}</div>
                                                     ...
                                                     {groupedNotification.notifications.map((notification, innerIndex) => (
                                                        <div key={innerIndex} className="w-full grid grid-cols-10 gap-2 my-2">
                                ...
                                <div className="w-full col-start-1 col-span-10 flex-col justify-bottom items-bottom " style={{ textAlign: 'center' }}>
                                                <Pagination

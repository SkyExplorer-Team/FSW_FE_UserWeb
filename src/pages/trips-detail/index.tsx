...
import { ConfigProvider, Dropdown, Layout, Collapse, Modal, Menu, Table } from "antd";
...
const Index: React.FC = () => {
    ...
    const durationInMinutes = bookingDetail.schedule.arrivalDate.diff(bookingDetail.schedule.departureDate, 'minutes');
                                                    ...
                                                    <div className="w-full col-start-1 col-end-6 flex group relative flex rounded-lg px-2">
                                                        <div className="w-full">
                                                            <div className="grid grid-cols-5 gap-1">
                                                                <div className="col-start-0 col-span-2 font-normal text-sm bg-white font-['Plus Jakarta Sans'] text-[#111] justify-start items-center inline-flex">{bookingDetail.schedule.from.city}</div>
                                                                ...
                                                                <div className="col-start-4 col-span-2 font-normal text-sm bg-white font-['Plus Jakarta Sans'] text-[#111] justify-start items-center inline-flex">{bookingDetail.schedule.to.city}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="grid grid-cols-12 w-full p-3" >
                                                    <div className="w-full col-start-1 col-end-8 flex group relative flex rounded-lg px-2">
                                                        <div className="w-full grid grid-cols-7 gap-1">
                                                            <div className="col-start-0 col-span-3 font-normal text-sm bg-white font-['Plus Jakarta Sans'] text-[#111] justify-start items-center inline-flex">{bookingDetail.schedule.departureDate.format('D MMMM YYYY')}</div>
                                                            <div className="col-start-4 col-span-1 bg-white justify-start text-primary font-bolder text-sm items-center inline-flex">
                                                                •
                                                            </div>
                                                            <div className="col-start-5 col-span-3 font-normal text-sm bg-white font-['Plus Jakarta Sans'] text-[#111] justify-start items-center inline-flex">{bookingDetail.schedule.departureDate.format('HH:mm')} - {bookingDetail.schedule.arrivalDate.format('HH:mm')} </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="grid grid-cols-12 w-full px-3 pb-2" >
                                                    <div className="w-full col-start-1 col-end-13 flex group relative flex rounded-lg ">
                                                        ...
                                                        >
                                                            ...
                                                            header={<>
                                                                <div className="col-start-0 col-span-2 font-normal text-sm bg-white font-['Plus Jakarta Sans'] text-[#111] justify-start items-center inline-flex mr-3">{bookingDetail.schedule.from.city}</div>
                                                                ...
                                                                <div className="col-start-4 col-span-2 font-normal text-sm bg-white font-['Plus Jakarta Sans'] text-[#111] justify-start items-center inline-flex mx-3">{bookingDetail.schedule.to.city}</div>
                                                            </>} style={{ width: "100%"}}>
                                                                Detail Info
                                                            </Collapse.Panel>
                                                        </Collapse>
                                                    ...
                                                    <div className="w-full col-start-1 col-end-12 flex group relative flex rounded-lg px-4">
                                                        <div className="flex items-center justify-center text-center">
                                                            <p className="font-normal text-sm text-[#354053]">
                                                                {bookingDetail.user.salutation} {bookingDetail.user.firstName} {bookingDetail.user.lastName}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="w-full col-start-1 col-end-13 rounded-md border border-solid border-neutral-300 bg-surface-additionals-over-color-frame-light">
                                                ...
                                                <div className="grid grid-cols-12 w-full px-3 py-2" >
                                                    ...
                                                    <div className="w-full col-start-7 col-end-13 flex group relative flex rounded-lg px-4 item-end justify-end text-right">
                                                        <div className="flex items-center ">
                                                            <p className="font-medium text-sm text-[#111]  text-right">
                                                                {new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(bookingDetail.totalCost)}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div className="w-full grid grid-cols-12">
                                    <div className=" col-start-2 col-end-12 py-6 bg-white rounded-[12px] shadow border border-gray-200 flex-col justify-center items-center">
                                        <div className="w-full grid grid-cols-12">
                                            ...
                                            <div className="w-full col-start-7 col-end-12 bg-white flex-col flex justify-center items-end">
                                                ...
                                                <p className="font-bold text-xs text-[#111] text-right">
                                                    {bookingDetail.schedule.departureDate.format('D MMMM YYYY')}
                                                    </p>
                                                </div>
                                            </div>
                                            <div className=" col-start-1 col-end-4 bg-white flex-col justify-center items-center pl-5">
                                                <div className="justify-center">
                                                    <div className="text-center text-[#111] font-medium font-['Plus Jakarta Sans'] font-bold text-2xl">{bookingDetail.schedule.departureDate.format('HH:mm')}</div>
                                                    <div className="text-center text-[#38A993] font-medium font-['Plus Jakarta Sans'] font-bold text-2xl">{bookingDetail.schedule.from.abv}</div>
                                                    <div className="text-center text-[#808991] font-medium font-['Plus Jakarta Sans'] font-semibold text-sm">{bookingDetail.schedule.departureDate.format('D MMM')}</div>
                                                </div>
                                            </div>
                                            ...
                                            <div className=" col-start-9 col-end-13 bg-white flex-col justify-center items-center pr-5">
                                                <div className="justify-center">
                                                    <div className="text-center text-[#111] font-medium font-['Plus Jakarta Sans'] font-bold text-2xl">{bookingDetail.schedule.arrivalDate.format('HH:mm')}</div>
                                                    <div className="text-center text-[#38A993] font-medium font-['Plus Jakarta Sans'] font-bold text-2xl">{bookingDetail.schedule.to.abv}</div>
                                                    <div className="text-center text-[#808991] font-medium font-['Plus Jakarta Sans'] font-semibold text-sm">{bookingDetail.schedule.arrivalDate.format('D MMM')}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-full grid grid-cols-12 gap-3 p-5">
                                            <div className="col-start-1 col-end-4 bg-white flex-col justify-center items-center">
                                                <div className="justify-center items-center bg-[#F2F4F7] rounded-[12px] p-4">
                                                    <div className="text-center text-sm font-semibold font-['Plus Jakarta Sans']">{bookingDetail.schedule.departureDate.format('HH:mm')}</div>
                                            ...
                                            <div className="col-start-7 col-end-10 bg-white flex-col justify-center items-center">
                                                <div className="justify-center items-center bg-[#F2F4F7] rounded-[12px] p-4">
                                                    <div className="text-center text-sm font-semibold font-['Plus Jakarta Sans']">{bookingDetail.seat}</div>
                                        ...
                                        <div className="w-full grid grid-cols-12 gap-3 px-5">
                                            <div className="col-start-1 col-end-7 bg-white flex-col justify-center items-center">
                                                <div className="justify-center items-center bg-[#F2F4F7] rounded-[12px] p-4">
                                                    <div className="text-center text-sm font-semibold font-['Plus Jakarta Sans']">{bookingDetail.user.salutation} {bookingDetail.user.firstName} {bookingDetail.user.lastName}</div>
                                            ...
                                            <div className="col-start-7 col-end-13 bg-white flex-col justify-center items-center">
                                                <div className="justify-center items-center bg-[#F2F4F7] rounded-[12px] p-4">
                                                    <div className="text-center text-sm font-semibold font-['Plus Jakarta Sans']">Economy</div>
                                        ...
                                        <div className="w-full grid grid-cols-12 gap-3 px-5 py-3">
                                            <div className="col-start-1 col-end-7 bg-white flex-col justify-center items-center">
                                                <div className="justify-center items-center">
                                                    ...
                                                    <div className="text-start text-xs font-bold font-['Plus Jakarta Sans']">{bookingDetail.user.salutation} {bookingDetail.user.firstName} {bookingDetail.user.lastName}</div>
                                                </div>
                                            </div>
                                            <div className="col-start-7 col-end-13 bg-white flex-col justify-center items-center">
                                                <div className="justify-center items-center">
                                        ...
                                        <div className="w-full grid grid-cols-12 gap-3 px-5">
                                            ...
                                            <div className="col-start-7 col-end-13 bg-white flex-col justify-center items-center">
                                                <div className="justify-center items-center">
                                                    ...
                                                    <div className="text-start text-xs font-bold font-['Plus Jakarta Sans']">{bookingDetail.schedule.departureDate.format('D MMMM YYYY')}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-full grid grid-cols-12 gap-3 p-5">

    ...
    <div className="grid grid-cols-12 w-full">
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-12 gap-4">
          <div
            className="h-screen flex col-span-12 md:col-span-3"            
          >
            <div className=" w-full hidden xl:block col-start-2 col-span-2 py-6  bg-white rounded-[16px] shadow border border-gray-200 flex-col justify-center items-center gap-4" style={{ height: "800px" }}>
                <div className="grid grid-cols-12 gap-4">
          ...
          <div
            className="h-screen flex col-span-12 md:col-span-9"          
          >
            <div
